...
export default function UserUnapprove(){
  ...
  const getSupplier=()=>{
      api.getrejectedsupplier().then(res=>{
  ...
  const getConsumer=()=>{
      api.getrejectedconsumer().then(res=>{
        if(res.data.status===200){
  ...
  const getReseller=()=>{
    api.getrejectedreseller().then(res=>{
      if(res.data.status===200){
            ...
            supplier.map((item,index)=>{
              return(
                  <Card 
                      ...
                      extra={
                                <p
                                  className='userUnapprove_button_reject' 
                                >
                                  已拒绝
                                </p>
                            }
                  >
                    <div style={{backgroundColor:"#FFE4E1",padding:"20px"}}>
            ...
            reseller.map((item,index)=>{
              return(
                  <Card 
                      ...
                      extra={
                                <p className='userUnapprove_button_reject'>                             
                                  已拒绝
                                </p>
                            }
                  >
